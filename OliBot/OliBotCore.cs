...
using OliBot.Classes.Helpers.Tokens;
using OliBot.Classes.Commands;
using OliBot.Classes.Helpers.Sites.Reddit;
using static OliBot.Classes.Events.OliBotEvents;
...
namespace OliBot
{
    class OliBotCore
    {
        ...
        {
            TokenHelper.LoadTokens(_tokenFile);
            await LoadStatuses();
        ...
        private async Task Login(string token)
        {
            ...
            try
            {
                ...
                OliBotClient.ChannelCreated += async e => await OliBotCore_ChannelCreated(e);
